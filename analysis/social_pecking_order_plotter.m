...
animal=animals{a, 1};
filename=['C:\Data\Tmaze\PFC_LH_group2_2022\' animal '_events.csv'];
%% Import csv
...
clear opts
%% chop
chop_from=datetime('2022-Mar-28 12:30:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
% chop_from=datetime('2021-Dec-15 11:00:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
chop_to=datetime('2022-Mar-28 19:30:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
...
%generic exp
bsl_from=datetime('2022-Mar-28 11:30:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
dreadd_from=datetime('2022-Mar-29 11:30:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
wo_from=datetime('2022-Mar-30 11:30:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
effect_window=hours(8);
...
%weight
filename=['C:\Data\Tmaze\PFC_LH_group2_2022\' animal '_weight.csv'];
...
j=1;
for t=[bsl_from, dreadd_from, wo_from]
%     trial_starts=soc.starts(find(x(soc(1).starts)>t & x(soc(1).starts)<t+effect_window),1);
