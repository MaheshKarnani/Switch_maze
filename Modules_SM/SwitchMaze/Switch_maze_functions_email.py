...
if test_answer==0:
    ...
    animal_reference_weights = [
    30,
    26,
    27,
    30,
    ]  # insert reference weights of mice here manually
    print('LIVE session with subjects:')
    print(animal_list)
    print('reference weights:')
    print(animal_reference_weights)
        ...
        if weight_data_mean<0.85*reference_weight  # animal has lost 15% body weight -- send an email to user  
            ...
            try:
                ...
                yag.send(
                    ...
                    subject="Switch maze welfare alarm",
                    contents="""
                    a mouse has dropped below 85 percent of its reference weight, take action
                    """,
                )
