...
close all, 
clear all
animals={'2006010073';'141821018292';'141821018139';'141821018263'};
'2 have pfc->lh dreadd 2006010073 and 141821018292 are ctrl';
f1=figure;
f2=figure;
f3=figure;
f4=figure;
...
clear opts
%% chop
chop_from=datetime('2022-Jun-15 10:30:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
% chop_from=datetime('2021-Dec-15 11:00:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
chop_to=datetime('2022-Jun-15 18:00:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
...
%generic exp
bsl_from=datetime('2022-Jun-07 11:30:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
dreadd_from=datetime('2022-Jun-08 11:30:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
wo_from=datetime('2022-Jun-13 11:30:00.000','InputFormat','yyyy-MM-dd HH:mm:ss.SSS');
